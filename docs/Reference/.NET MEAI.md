...
## Status
The base `SmooAI.SmoothAgent` protocol client (generated types + streaming `IAsyncEnumerable<ServerEvent>` + HITL) is done. The MEAI facade, DI extensions, `SmoothAgentThread`, and OTel conventions are tracked in [[Roadmap]] (Phase 5 service hosts / Phase 3 OTel).

---

**In this vault:** [[Home]] · [[Using the Polyglot Clients]] · [[The Protocol]] · [[Roadmap]]

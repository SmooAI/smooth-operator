...
[[Connectors#the-github_search-tool-live-fresh-lookups|CONNECTORS.md]].
...
- [[Storage Adapters]] — the `StorageAdapter` seam the tools read through.
- [[Architecture Overview]] — where tools sit in the agent turn.
- `rust/smooth-operator/src/tools/` — the implementations.

---

**In this vault:** [[Home]] · [[Agents, Tools, and Workflows]] · [[Knowledge and RAG]] · [[Connectors]] · [[Writing a Connector]]
